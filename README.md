...
# 팀소개
### 저희팀은 Pusan Natinal Uiversity Developer Students  Club(DSC) 에 속해있는 팀으로 DSC멤버들로 구성된 팀 입니다. 저희팀은 김현지 세션장(코어멤버) 가 진행한 학기중 머신러닝 세션을 함께 진행하면서 이루어진 팀으로, "AI 기술을 적용한 앱서비스를 개발하고싶다" 라는 같은 마음과 뜻을 가지고 모여 개발을 시작하게 되었습니다. 저희는 많은 고심끝에 만들어낸 "위대한 균형" 이많은 고연령 인구층의 균형잡힌 운동을 도와주고, 낙상사고의 예방에 도움이 되기를 바랍니다.
